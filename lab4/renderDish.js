document.addEventListener("DOMContentLoaded", () => {
    const sections = {
        soup: document.querySelector("section[data-category='soup'] .dish-content"),
        mainDish: document.querySelector("section[data-category='mainDish'] .dish-content"),
        drink: document.querySelector("section[data-category='drink'] .dish-content"),
    };
    ...
    function highlightSelectedDish(category, selectedCard) {
        const sectionCards = sections[category].querySelectorAll(".product-card");
    ...
    function updateOrderVisibility() {
        ...
        orderSummarySection.style.display = isAnyDishSelected ? "block" : "none";
        totalCostSection.style.display = isAnyDishSelected ? "block" : "none";
    }

    function updateTotalCost() {
        totalPrice = Array.from(Object.values(orderSummary)).reduce((total, item) => {
